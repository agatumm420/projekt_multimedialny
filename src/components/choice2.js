  ...
  return (
    <div className="level">
      <div className="background-2">
        <video width="850" height="700" autoPlay muted>
          <source
            src={`${process.env.PUBLIC_URL}` + `/good.mp4`}
            type="video/mp4"
          />
        </video>
        <ReactAudioPlayer
          src={`${process.env.PUBLIC_URL}` + `/goodending.mp3`}
          autoPlay={true}
          controls
          listenInterval={1000}
        ...
        {ended ? (
          <div className="congrats">
            <p id="congrat-text">Congratulations! You've bitten the game!</p>
